<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customersignup.aspx.cs" Inherits="transx.customersignup" %>
...
&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" CssClass="butt" ForeColor="#21BA25" Height="46px" Text="SIGN UP" Width="130px" />
            <br />
            <br />
            <br />
            <br />
