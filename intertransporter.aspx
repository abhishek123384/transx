<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="intertransporter.aspx.cs" Inherits="transx.intertransporter" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style1" style="                background-image: none;
                ...
                ">
            <asp:ImageButton ID="ImageButton1" runat="server" Height="33px" ImageUrl="~/imagee/my ingae1.png"  Width="95px" OnClick="ImageButton1_Click" />
        </div>
            <asp:Panel ID="Panel1" runat="server" CssClass="yourorder-panel" Height="411px">
                ...
                <br />
                &nbsp;&nbsp;&nbsp;
                <asp:Label ID="Label3" runat="server" Text="OWNER NO:"></asp:Label>
                <asp:TextBox ID="TextBox2" runat="server" CssClass="maintextbox" ReadOnly="True"></asp:TextBox>
                <br />
                <br />
                &nbsp;&nbsp;
                <asp:Label ID="Label5" runat="server" Text="TRANSPORT NAME:"></asp:Label>
                ...
                &nbsp;&nbsp;
                <br />
                <asp:Label ID="Label11" runat="server" Text="TYPE OF BUSSINESS:"></asp:Label>
                <asp:TextBox ID="TextBox6" runat="server" CssClass="maintextbox" ReadOnly="True"></asp:TextBox>
                <br />
            
            </asp:Panel>
        </div>
        <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#9932CC" BorderStyle="solid" BorderWidth="3px" CellPadding="4" CssClass="maingrid" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
