<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sign up.aspx.cs" Inherits="transx.sign_up" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="auto-style1" style="                background-image: url('images/loading-the-truck.gif');
            ...
            <br />
            <br />
            <asp:Label ID="Label6" runat="server" CssClass="koli" ForeColor="Blue" Text="OWNER NAME:"></asp:Label>
            <asp:TextBox ID="TextBox3" runat="server" CssClass="nomi" Height="34px" Width="580px"></asp:TextBox>
            <br />
            <br />
&nbsp;&nbsp;
            <asp:Label ID="Label7" runat="server" CssClass="koli" ForeColor="Blue" Text="transport name:"></asp:Label>
            <asp:TextBox ID="TextBox4" runat="server" CssClass="nomi" Width="434px"></asp:TextBox>
            <br />
            <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Label ID="Label10" runat="server" CssClass="koli" ForeColor="Blue" Text="business type:"></asp:Label>
            <asp:TextBox ID="TextBox7" runat="server" CssClass="nomi" Height="28px" Width="257px"></asp:TextBox>
&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label11" runat="server" CssClass="koli" ForeColor="Blue" Text="boundary:"></asp:Label>
            <asp:TextBox ID="TextBox8" runat="server" CssClass="nomi" Height="27px" Width="151px"></asp:TextBox>
            <br />
            <br />
            <br />
...
&nbsp;&nbsp;
            ...
            <asp:Label ID="Label12" runat="server" BorderColor="Red" BorderStyle="Dotted" BorderWidth="5px" ForeColor="Red"></asp:Label>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="Button1" runat="server" CssClass="butt" ForeColor="#21BA25" Height="46px" Text="SIGN UP" Width="130px" OnClick="Button1_Click1" />
            <br />
            <br />
            <br />
            <br />
