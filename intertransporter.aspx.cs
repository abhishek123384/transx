...
namespace transx
{
    public partial class intertransporter : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                using (SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Abhishek\source\repos\transx\transx\App_Data\transx.mdf;Integrated Security=True"))
                {
                ...
                protected void chk_chekedchange(object sender, EventArgs e)
                {
                    ...
                    if (ch.Checked == true)
                    {
                        ...
                        TextBox5.Text = GridView1.Rows[rowind].Cells[5].Text;
                        TextBox6.Text = GridView1.Rows[rowind].Cells[6].Text;
                    }
                    else
                    {
